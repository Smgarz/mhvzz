  ...
  <div class="h-outer">
    ...
    <div class="iphonNav navigation clearfix menu">
      <ul>
        ...
        <li class="active"> <a class="topmenu" href="livigno-surroundings.php">Livigno Surroundings</a></li>
...
$get_nms 		 =  	$rsscat_url[$countcat_ur-1]; 
	...
	{
		echo '<img src="images/tea-da-bondi-banner.jpg" alt="Vacation rentals apartments Italy">';
		
	}	
	elseif($get_nms=='chalet-kiwi.php')
	{
		echo '<img src="images/kiwi-banner.jpg" alt="Vacation rentals apartments Italy">';
		
	}
 elseif($get_nms=='InfoRequest.php')
	{
		echo '<img src="images/bannerr.jpg" alt="Livigno request Italy">';
		
	}
	 elseif($get_nms=='directions-livigno.php')
	{
		echo '<img src="images/directions-banner.jpg" alt="How to reach Italy livigno">';
		
	}
	 elseif($get_nms=='livigno-surroundings.php')
	{
		echo '<img src="images/surroundingsi-banner.jpg" alt="Livigno Italy">';
